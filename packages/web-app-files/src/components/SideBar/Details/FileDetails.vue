    ...
    <div v-if="hasContent">
      ...
      >
        <tr v-if="hasTimestamp" data-testid="timestamp">
          <th scope="col" class="oc-pr-s" v-text="$gettext('Last modified')" />
          <td>
            <oc-button
              v-if="showVersions"
        ...
        <tr v-if="showSharedVia" data-testid="shared-via">
          <th scope="col" class="oc-pr-s" v-text="$gettext('Shared via')" />
          <td>
        ...
        <tr v-if="showSharedBy" data-testid="shared-by">
          <th scope="col" class="oc-pr-s" v-text="$gettext('Shared by')" />
          <td>
            <span v-text="sharedByDisplayName" />
          </td>
        </tr>
        <tr v-if="ownerDisplayName" data-testid="ownerDisplayName">
          <th scope="col" class="oc-pr-s" v-text="$gettext('Owner')" />
          <td>
            <p class="oc-m-rm">
              {{ ownerDisplayName }}
        ...
        <tr v-if="showSize" data-testid="sizeInfo">
          <th scope="col" class="oc-pr-s" v-text="$gettext('Size')" />
          <td v-text="resourceSize" />
        </tr>
        <tr v-if="showVersions" data-testid="versionsInfo">
          <th scope="col" class="oc-pr-s" v-text="$gettext('Versions')" />
          <td>
            <oc-button
              v-oc-tooltip="seeVersionsLabel"
              appearance="raw"
        ...
        <tr v-if="runningOnEos" data-testid="eosPath">
          <th scope="col" class="oc-pr-s" v-text="$gettext('EOS Path')" />
          <td>
        ...
        <tr v-if="runningOnEos" data-testid="eosDirectLink">
          <th scope="col" class="oc-pr-s" v-text="$gettext('Direct link')" />
          <td>
            <div class="oc-flex oc-flex-middle oc-flex-between oc-width-1-1">
        ...
        <tr v-if="showTags" data-testid="tags">
          <th scope="col" class="oc-pr-s" v-text="$gettext('Tags')" />
          <td>
